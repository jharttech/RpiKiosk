...
$ sudo apt-get install git vim clutter</pre></code>
					...
					<p id="blog">If you wish to download the deb package version download the file then run the following commands: <a href="https://github.com/jharttech/RpiKiosk/raw/master/files/RpiKiosk_1.0-2.deb">rpikiosk_1.0-2.deb</a></br></p>
