...
$ sudo apt-get install git vim clutter</pre></code>
					...
					<p id="blog">If you wish to download the deb package version download the file then run the following commands: <a href="https://github.com/jharttech/RpiKiosk/raw/master/files/RpiKiosk_1.0-3.deb">rpikiosk_1.0-3.deb</a></br></p>
					<code><pre>$ cd /path/to/downloaded/rpikiosk_1.0-3.deb
$ sudo dpkg -i rpikiosk_1.0-3.deb</pre></code>
